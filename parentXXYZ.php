...
$obj ->get_ChangePass();
$message12= "<p><span class='green'>Your password has been changed.</span></p>";
}
else{
	$message12="<p>Your passwords did not match</p>";
	}
}
...
<div class="container">
    ...
    <div class="fourteen columns offset-by-one"><?php include 'topnav.php' ;?></div>         
     ...
     <div class="fifeteen columns offset-by-one">	
     	...
     	<p class="admintitle">Editing Password for </p>
     </div>
      
      <div class="fourteen columns offset-by-one">  
        <?php echo $message12 ; echo $message13 ;?>
        <?php $obj ->get_ParentPassChange() ;?>
